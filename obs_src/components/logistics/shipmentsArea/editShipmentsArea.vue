    ...
    <div class="el-container">
      <el-form :model="option" label-width="100px" ref="ruleForm" :rules="rules">
        <el-form-item label="运费模板" prop="templateId">
          <el-row>
            <el-col :span="4">
              <el-select v-model="option.templateId" disabled>
        ...
        <el-form-item label="区域" prop="shippingAreaId">
          <el-row>
            <el-col :span="4">
              <el-select v-model="option.shippingAreaId" disabled>
        ...
        <el-form-item label="">
          <el-button type="primary" @click="addAreaSave('ruleForm')" v-if="self.showAction_('logistics/template-area-rel/edit')">保存</el-button>
          <el-button type="danger" @click="cancelSave"  v-if="self.showAction_('logistics/template-area-rel/edit')">取消</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
  ...
  export default {
    ...
    methods: {
      ...
      init (){
          ...
          this.option.templateId = this.row.templateId;
          this.option.shippingAreaId = this.row.shippingAreaId;
      ...
      addAreaSave (formName){
        this.$refs[formName].validate((valid) => {
          ...
          this.$http.post('logistics/template-area-rel/edit', this.option).then( res => {
            if (res.body.code === 0) {
