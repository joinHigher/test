	...
	<div>
        <div class="el-container">
            <div class="el-sub-container text-right">
                <router-link v-if="self.showAction_('admin/mail-template/add')" :to="{name: 'notice_systemMailAdd'}" class="el-button el-button--primary">新建模板</router-link>
            </div>
            <el-table :data="tableData" border v-loading="tableLoading">
                ...
                <el-table-column label="操作">
                    <template scope="scope">
                        <router-link v-if="self.showAction_('admin/mail-template/info')" :to="{name: 'notice_systemMailEdit', query: {id: scope.row.id}}" class="el-button el-button--primary el-button--small">编辑</router-link>
                        <el-button v-if="self.showAction_('admin/mail-template/delete')" @click="delConfirm(scope.row)" type="danger" size="small">删除</el-button>
                    </template>
				</el-table-column>
            </el-table>
        </div>
