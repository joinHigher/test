<template>
	<div>
        <el-breadcrumb separator="/" class="el-container top">
            ...
            <el-breadcrumb-item>板块详情</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="el-container text-box">
            <el-row>
                <el-col :span="8">
            ...
            <el-table border :data="tableData" @selection-change="changeRemoveList">
                ...
                <el-table-column label="操作">
                    <template scope="scope">
                        ...
                        <el-button v-show="scope.row.showEdit" size="small" type="primary" @click="saveOrder(scope.row)">保存</el-button>  
                        <el-button size="small" type="danger" @click="removeGood(scope.row)">删除</el-button>    
                    </template>
                </el-table-column>
            </el-table>
            <div class="el-sub-container text-right">
                <el-pagination @size-change="ChangePageSize" @current-change="ChangePage" :current-page="1" :page-sizes="[20, 50]" layout="total, sizes, prev, pager, next, jumper" :page-size="option.page_size * 1" :total="total">
                </el-pagination>
            </div>
        </div>
        <!-- 弹窗S -->
