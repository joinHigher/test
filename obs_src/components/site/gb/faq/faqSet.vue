                ...
                <el-row>
                    <el-col :span="7">
                        ...
                        <el-form-item label="是否底部显示">
                            <el-col :span="16">
                                <el-radio-group v-model="addForm.is_show_at_bottom">
                                    <el-radio class="radio"  :label="1 * 1">显示</el-radio>
                                    <el-radio class="radio"  :label="0 * 1">不显示</el-radio>
                                </el-radio-group>
                            </el-col>
                        </el-form-item>
                        <el-form-item label="是否左侧显示">
                            <el-col :span="16">
                                <el-radio-group v-model="addForm.is_show_at_left">
                                    <el-radio class="radio"  :label="1 * 1">显示</el-radio>
                                    <el-radio class="radio"  :label="0 * 1">不显示</el-radio>
                                </el-radio-group>
                            </el-col>
